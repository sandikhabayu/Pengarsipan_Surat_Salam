...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="{{ route('petugas.surat-template.update', $suratTemplate->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex gap-2">
                    <div>
                        <label for="nomor_urut" class="block text-md font-medium text-gray-950">Nomor Urut</label>
                        <input type="text" name="nomor_urut" id="nomor_urut"
                            value="{{ old('nomor_urut', explode('/', $suratTemplate->nomor_surat)[0] ?? '') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#17AD90] focus:ring focus:ring-[#17AD90] focus:ring-opacity-50">
                    </div>
                    <div class="flex items-center justify-center">
                        <span class="text-gray-700 font-medium text-2xl">/</span>
                    </div>
                    <div>
                        <label for="format_surat" class="block text-md font-medium text-gray-950">Format Surat</label>
                        <input type="text" name="format_surat" id="format_surat"
                            value="{{ old('format_surat', $suratTemplate->format_surat ?? '') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#17AD90] focus:ring focus:ring-[#17AD90] focus:ring-opacity-50">
                    </div>
                </div>
                <!-- Preview Nomor Surat -->
                <div class="mb-4 p-3 bg-blue-50 rounded border border-blue-200">
                    ...
                    <p class="text-lg font-bold">
                        {{ old('nomor_urut', explode('/', $suratTemplate->nomor_surat)[0] ?? '') }}/<span
                            id="preview-format">{{ old('format_surat', $suratTemplate->format_surat ?? '[format]') }}</span>
                    </p>
                </div>
                ...
                <input type="hidden" name="format_surat" value="AUTO">

                <div>
                    <label for="lampiran" class="block text-md font-medium text-gray-950">Lampiran</label>
                    <input type="text" name="lampiran" id="lampiran"
                        value="{{ old('lampiran', $suratTemplate->lampiran) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#17AD90] focus:ring focus:ring-[#17AD90] focus:ring-opacity-50">
                    @error('lampiran')
                ...
                <div>
                    <label for="perihal" class="block text-md font-medium text-gray-950">Perihal</label>
                    <input type="text" name="perihal" id="perihal"
                        value="{{ old('perihal', $suratTemplate->perihal) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#17AD90] focus:ring focus:ring-[#17AD90] focus:ring-opacity-50">
                    @error('perihal')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="tanggal" class="block text-md font-medium text-gray-950">Tanggal</label>
                    <input type="date" name="tanggal" id="tanggal"
                        value="{{ old('tanggal', $suratTemplate->tanggal) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#17AD90] focus:ring focus:ring-[#17AD90] focus:ring-opacity-50">
                    @error('tanggal')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="kepada" class="block text-md font-medium text-gray-950">Kepada</label>
                    <input type="text" name="kepada" id="kepada" value="{{ old('kepada', $suratTemplate->kepada) }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#17AD90] focus:ring focus:ring-[#17AD90] focus:ring-opacity-50">
                    @error('kepada')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
